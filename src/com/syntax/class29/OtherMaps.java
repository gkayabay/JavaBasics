...
public class OtherMaps {
	...
	public static void main(String[] args) {
		...
		//store objects in a form of K and V and you want to sort your keys is Ascending(alphabetical) order
		...
		population.put("Kazakhstan",1800000000);
		population.put("India",1326000000);
		population.put("Afghanistan",370000000);
