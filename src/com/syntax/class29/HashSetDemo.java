...
public class HashSetDemo {
	...
	public static void main(String[] args) {
		// create a collection that will store only unique objects we do not care about the order 
	     ...
	     //we need to retrieved an element-->not get() method avaliable
	     ...
	     //we cannot use for loop becuase no get() method
